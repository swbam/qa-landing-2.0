      ...
      <div>
        <nav className="bg-gray-100 p-4">
          <ul className="flex space-x-4">
            <li>
              <Link to="/" className="text-blue-600 hover:text-blue-800">Main App</Link>
            </li>
            <li>
              <Link to="/search-component" className="text-blue-600 hover:text-blue-800">Search Component Preview</Link>
            </li>
          </ul>
        </nav>
        ...
        <Routes>
          ...
          <Route path="/search-component" element={<SearchComponentPreview />} />
        </Routes>
      </div>
    </Router>
  );
...
function SearchComponentPreview() {
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="p-4">
        <h1 className="text-2xl font-bold mb-4">Search Component Preview</h1>
        <div className="mb-4">
          <p className="text-gray-600">This is an isolated preview of the SearchComponent.</p>
        </div>
      </div>
      <SearchComponent />
    </div>
