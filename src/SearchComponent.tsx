...
const SearchComponent: React.FC<SearchComponentProps> = ({ 
  ...
  return (
    <div className="quickauction-full-component">
      {/* Blue background section with headline */}
      <div className="bg-primary py-16 text-center text-white" style={{ backgroundColor: styles.primary }}>
        <div className="max-w-5xl mx-auto px-4">
          <h1 className="text-5xl font-bold mb-6">Car shopping your way</h1>
          <p className="text-xl">List your vehicle today and watch as buyers compete with bids to give you the best market value.</p>
        </div>
      </div>

      {/* Component container */}
      <div className="bg-white rounded-[3px] shadow-lg p-6 max-w-5xl mx-auto -mt-8 relative">
        {/* Tabs */}
